    ...
    export const surahs = [
        ...
        { number: 13, name: 'الرعد', ayahs: 43 }, { number: 14, name: 'ابراهيم', ayahs: 52 },
        ...
        { number: 33, name: 'الأحزاب', ayahs: 73 }, { number: 34, name: 'سبإ', ayahs: 54 },
        ...
        { number: 75, name: 'القيامة', ayahs: 40 }, { number: 76, name: 'الانسان', ayahs: 31 },
        { number: 77, name: 'المرسلات', ayahs: 50 }, { number: 78, name: 'النبإ', ayahs: 40 },
        { number: 79, name: 'النازعات', ayahs: 46 }, { number: 80, name: 'عبس', ayahs: 42 },
        { number: 81, name: 'التكوير', ayahs: 29 }, { number: 82, name: 'الإنفطار', ayahs: 19 },
        { number: 83, name: 'المطففين', ayahs: 36 }, { number: 84, name: 'الإنشقاق', ayahs: 25 },
